...
// Ajout des id permettant l'accès aux différentes sections depuis le menu
// Modification de la gestion des data
// Création d'une fonction "sort" pour afficher la dernière prestation
    ...
    <>
      ...
      <footer className="row">
        ...
        <div className="col contact">
          ...
          {/* Ajout d'un lien tel pour le numéro de téléphone */}
          <a href="tel:0123456789">01 23 45 67 89</a>
          {/* Ajout d'un lien mailto pour l'adresse email */}
